...
from ..utils import K, car_name2id, car_id2name, intrinsic_vec_to_mat, euler_angles_to_rotation_matrix, \
                                rotation_matrix_to_euler_angles, convert_pose_mat_to_6dof, project, pose_extraction

class PreprocessApolloscape:

    #reprocessNuscenes(args.dir_ann, args.dir_nuscenes, args.dataset, args.iou_min)
    #prep.run()
    ...
    def __init__(self, dir_ann, dir_apollo, dataset, iou_min):
        ...
        self.apollo, self.scenes, self.split_train, self.split_val = factory(dataset, dir_apollo)
